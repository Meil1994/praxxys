...
<body>
    <div class="h-screen bg-gradient-to-t from-stone-700 to-slate-600 overflow-scroll">
        <div class="flex justify-center items-center h-screen">
            <form 
            method="POST" action="{{ route('emaillogin') }}"
            class="w-80 p-8 pt-10 pb-10 ring-2 ring-amber-600 shadow-lg shadow-black">
            @csrf
            <p class="text-white text-center mb-5">LOGIN WITH EMAIL</p>
            <input 
                name="email"
            ...
            <div class="flex justify-center mt-10 text-sm text-blue-500">
                <a href="/api/login" class="hover:text-blue-400">Login using Username</a>
            </div>
        </form>
        </div>
    </div>
